...
-- Tools Tab
local ToolsTab = Window:CreateTab("Tools", 11435662308)
...
-- Visuals Tab
local VisualsTab = Window:CreateTab("Visuals", 10686484299)
...
-- Others Tab
local OtherTab = Window:CreateTab("Other", 11087437445)
...
-- Character Tab
local CharacterTab = Window:CreateTab("Character", 9457123174)
